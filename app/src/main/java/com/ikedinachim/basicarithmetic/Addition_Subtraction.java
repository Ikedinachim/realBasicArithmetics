...
public class Addition_Subtraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_addition__subtraction);
        ...
        playAgain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sumView.setText(Integer.toString(numbs[0])+""+Integer.toString(numbs[1])+"+"+Integer.toString(numbs[2]));
                generateQuestions(numbs[0] + numbs[1] + numbs[2]);
...
//                    timerProgressBar.setProgress(30);//hj
    ...
    public int[] generateNumbers(int numOfQues){
        ...
        int[] numbers;
        if (max != 30){ max = 30;}
        if (currentProgressTimer != 30){ currentProgressTimer = 30;}
        if (numOfQues <= 5){
            num1  = random.nextInt(12);
            num2 = random.nextInt(13)-12;
            num3 = random.nextInt(12);
            currentProgressTimer = 30;
            max = 30;
            timerProgressBar.setMax(max);
            timerProgressBar.setProgress(currentProgressTimer);
        ...
        if (numOfQues <= 15){
            ...
            num2 = random.nextInt(31)-30;
            num3  = random.nextInt(20) + 30;
        ...
        if (numOfQues <= 30){
            ...
            num2 = random.nextInt(71)-70;
            num3 = random.nextInt(50)+100;
        ...
        timerProgressBar.setMax(max);
        timerProgressBar.setProgress(currentProgressTimer);
        return new int[]{random.nextInt(150)+200, random.nextInt(151)-150,random.nextInt(150)+200};
    }
    ...
    public void storeHighScore(int highScore){
        ...
        store = getSharedPreferences("ADDSUB", 0);
        SharedPreferences.Editor editor = store.edit();
        editor.putInt("ADDSUB",highScore);
        editor.commit();

    }
    public int retrieveHighScore(){
        store = getSharedPreferences("ADDSUB", 0);
        int hscore = store.getInt("ADDSUB", 0); //0 is the default value
        return  hscore;
    }
}
