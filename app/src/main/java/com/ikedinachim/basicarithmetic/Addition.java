...
//                    timerProgressBar.setProgress(30);//hj
        ...
        adView.loadAd(adRequest);//ca-app-pub-9738106405881817/6354365294
...
//                    timerProgressBar.setProgress(30);//hj
    ...
    public void storeHighScore(int highScore){
        ...
        store = getSharedPreferences("ADDITION", 0);
        SharedPreferences.Editor editor = store.edit();
        editor.putInt("ADDITION",highScore);
        editor.commit();

    }
    public int retrieveHighScore(){
        store = getSharedPreferences("ADDITION", 0);
        int hscore = store.getInt("ADDITION", 0); //0 is the default value
        return  hscore;
    }
}
